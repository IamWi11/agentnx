...
const translations = {
  en: {
    ...
    pricing: {
      ...
      sub: "AI agents that automate compliance workflows, approvals, and documentation — built for regulated industries.",
      ...
      plans: [
        {
          name: "Starter",
          description: "One AI agent. Always on. No per-deviation or per-minute billing.",
          features: ["1 agent", "1,000 QA interactions/mo", "Basic configuration", "Email support", "Deviation intake"],
          cta: "Get Started",
        },
        {
          name: "Growth",
          description: "Multiple agents with custom prompts. Built for teams that are scaling.",
          features: ["3 agents", "3,000 QA interactions/mo", "Custom prompts & flows", "Priority support", "LIMS + Veeva routing"],
          cta: "Get Started",
        },
        {
          name: "Enterprise",
          description: "Site license. Built for regulated industries with LIMS, SAP & Veeva Vault.",
          features: ["Up to 10 agent configurations", "21 CFR Part 11 compliant", "Veeva, SAP & LIMS integration included", "Unlimited deviation events · site license", "HIPAA + GxP documentation", "Dedicated onboarding"],
          cta: "Contact Us",
        },
      ],
      faq: [
        { q: "How fast can my agent be live?", a: "Most agents are configured and live within 5 business days of onboarding." },
        { q: "Is there per-minute or per-deviation billing?", a: "No. All plans are flat monthly rates — no per-minute, per-call, or per-deviation charges." },
        { q: "Can I cancel anytime?", a: "Yes. Month-to-month. Cancel through your billing portal with no penalties." },
        { q: "Is this HIPAA or GxP compliant?", a: "Enterprise tier includes 21 CFR Part 11 validation documentation, HIPAA BAA, and GxP-ready deployment. In production, AgentNX deploys inside your environment — your data never leaves your network." },
      ],
    },
  },
  ...
  es: {
    ...
    pricing: {
      ...
      sub: "Agentes de IA que automatizan flujos de cumplimiento, aprobaciones y documentación — para industrias reguladas.",
      ...
      plans: [
        {
          name: "Starter",
          description: "Un agente de IA. Siempre activo. Sin cobros por minuto ni por desviación.",
          features: ["1 agente", "1,000 interacciones QA/mes", "Configuración básica", "Soporte por correo", "Intake de desviaciones"],
          cta: "Comenzar",
        },
        {
          name: "Growth",
          description: "Múltiples agentes con prompts personalizados. Diseñado para equipos en crecimiento.",
          features: ["3 agentes", "3,000 interacciones QA/mes", "Prompts y flujos personalizados", "Soporte prioritario", "Enrutamiento LIMS + Veeva"],
          cta: "Comenzar",
        },
        {
          name: "Enterprise",
          description: "Licencia por sitio. Para industrias reguladas con LIMS, SAP y Veeva Vault.",
          features: ["Hasta 10 configuraciones de agente", "Cumplimiento 21 CFR Parte 11", "Integración Veeva, SAP y LIMS incluida", "Eventos de desviación ilimitados · licencia por sitio", "Documentación HIPAA + GxP", "Onboarding dedicado"],
          cta: "Contáctanos",
        },
      ],
      faq: [
        ...
        { q: "¿Hay cobros por minuto o por desviación?", a: "No. Todos los planes tienen una tarifa mensual fija — sin cobros por minuto, por llamada ni por desviación." },
        { q: "¿Puedo cancelar en cualquier momento?", a: "Sí. Mes a mes. Cancela desde tu portal de facturación sin penalizaciones." },
        { q: "¿Es compatible con HIPAA o GxP?", a: "El nivel Enterprise incluye documentación de validación 21 CFR Parte 11, BAA para HIPAA y despliegue listo para GxP. En producción, AgentNX se despliega dentro de tu entorno — tus datos nunca salen de tu red." },
      ],
    },
  },
};
