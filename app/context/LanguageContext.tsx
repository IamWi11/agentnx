      ...
      plans: [
        {
          ...
          features: ["1 custom voice agent", "Up to 1,000 calls/month", "VAPI-powered (phone + web)", "Standard onboarding", "Email support", "Monthly performance report"],
          cta: "Get Started",
        },
        {
          name: "Growth",
          description: "Multiple agents. Custom scripts. Built for teams that are scaling.",
          features: ["3 custom voice agents", "Up to 3,000 calls/month", "Custom call scripts & flows", "CRM integration", "Priority support", "Weekly performance reports", "Apollo.io outbound integration"],
          cta: "Get Started",
        },
        {
          name: "Enterprise",
          description: "15,000 min/mo included. Built for compliance-heavy industries with LIMS, SAP & Veeva.",
          features: ["Up to 15,000 min/month included", "Overage at $0.05/min", "LIMS, SAP QM & Veeva Vault integration", "GxP / HIPAA-ready documentation", "Dedicated account manager", "White-label option", "SLA guarantee"],
          cta: "Get Started",
        },
      ],
      faq: [
      ...
      plans: [
        {
          ...
          features: ["1 agente de voz personalizado", "Hasta 1,000 llamadas/mes", "Con tecnología VAPI (teléfono + web)", "Onboarding estándar", "Soporte por correo", "Informe mensual de rendimiento"],
          cta: "Comenzar",
        },
        {
          name: "Growth",
          description: "Múltiples agentes. Scripts personalizados. Diseñado para equipos en crecimiento.",
          features: ["3 agentes de voz personalizados", "Hasta 3,000 llamadas/mes", "Scripts y flujos personalizados", "Integración con CRM", "Soporte prioritario", "Informes semanales de rendimiento", "Integración outbound con Apollo.io"],
          cta: "Comenzar",
        },
        {
          name: "Enterprise",
          description: "15,000 min/mes incluidos. Para industrias con alto cumplimiento — LIMS, SAP y Veeva.",
          features: ["Hasta 15,000 min/mes incluidos", "Excedente a $0.05/min", "Integración LIMS, SAP QM y Veeva Vault", "Documentación GxP / HIPAA", "Gestor de cuenta dedicado", "Opción de marca blanca", "Garantía de SLA"],
          cta: "Comenzar",
        },
      ],
      faq: [
